    ...
    <>
      ...
      <div className="mx-auto max-w-2xl">
        <div className="my-10 px-5 text-sm">
          ...
          <h2 className={headStyle}>第1条（適用）</h2>
          <p>
          ...
          <h2 className={headStyle}>第2条（利用登録）</h2>
          <p>
          ...
          <h2 className={headStyle}>第3条（ユーザー情報の管理）</h2>
          <p>
          ...
          <h2 className={headStyle}>第4条（利用料金）</h2>
          <p>
            ユーザーは、本サービスを無料で利用することができます。本サービス内で利用料金を請求することはありません。
          </p>
          <h2 className={headStyle}>第5条（禁止事項）</h2>
          <p></p>
          ...
          <h2 className={headStyle}>第6条（本サービスの提供の停止等）</h2>
          <p>
          ...
          <h2 className={headStyle}>第7条（利用制限および登録抹消）</h2>
          <p>
          ...
          <h2 className={headStyle}>第8条（退会）</h2>
          <p>
            ユーザーは、本サービスの定める退会手続により、本サービスから退会できるものとします。
          </p>
          <h2 className={headStyle}>第9条（保証の否認および免責事項）</h2>
          <p>
          ...
          <h2 className={headStyle}>第10条（サービス内容の変更等）</h2>
          <p>
            本サービスはユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
          </p>
          <h2 className={headStyle}>第11条（利用規約の変更）</h2>
          <p>
