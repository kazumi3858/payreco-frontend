    ...
    <>
      ...
      <div className="mx-auto max-w-2xl">
        <div className="my-10 px-5 text-sm">
          ...
          <h3 className={headStyle}>第1条（個人情報）</h3>
          <p>
            「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、特定の個人を識別できる情報（個人識別情報）を指します。
          </p>
          <h3 className={headStyle}>第2条（個人情報の収集方法）</h3>
          <p>
            本サービスは、ユーザーが利用登録をする際にユーザーのGoogleアカウント情報を取得します。
          </p>
          <h3 className={headStyle}>第3条（個人情報を収集・利用する目的）</h3>
          ...
          <h3 className={headStyle}>第4条（利用目的の変更）</h3>
          <p>
          ...
          <h3 className={headStyle}>第5条（個人情報の第三者提供）</h3>
          <p>
            本サービスはユーザーの同意を得ることなく、第三者に個人情報を提供することはありません。
          </p>
          <h3 className={headStyle}>第6条（退会時）</h3>
          <p>
            ユーザーが本サービスの退会手続きを行った場合、本サービスはユーザーの個人情報を全て削除します。
          </p>
          <h3 className={headStyle}>第7条（プライバシーポリシーの変更）</h3>
          <p>
