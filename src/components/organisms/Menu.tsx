...
function Menu() {
  const style = (text: string) =>
    `${text} w-1/3 md:w-1/4 inline-block text-white text-sm md:text-base py-3 px-1 sm:px-3 md:px-5 bg-main-button-color hover:bg-sub-button-color focus:outline-none focus:ring focus:ring-stone-300`;
  return (
